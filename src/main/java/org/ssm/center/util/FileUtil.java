...
public class FileUtil {
     ...
     * @return
     */
    public static String uploadFile(HttpServletRequest request, MultipartFile file, boolean isRandomName) throws IOException {
        //上传
            ...
            /*try {
                ...
                if(file!=null){
                    ...
                    if (type!=null) {
                        ...
                        if (booIsType) {
                            //存放图片文件的路径
                            String path="E:\\testFile\\"+fileType+"\\";
                            System.out.print("文件上传的路径"+path);
                            //组合名称

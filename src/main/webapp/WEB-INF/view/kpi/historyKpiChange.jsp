...
<div class="down-main">
    ...
    <div class="row">
        <div class="col-md-3 col-md-offset-2" style="margin-top: 20px">
            <form  class="form-horizontal">
                <div class="form-group">
                    <label for="userId">用户名</label>
                    <input type="number"  class="form-control input-sm" id="userId" name="sId">
                </div>

                <div class="form-group">
                    <label for="kpiNumber">请选择要修改的考核月次</label>
                    <input type="date"  class="form-control input-sm" id="kpiNumber" name="kpiNumber">
                </div>
                <div class="form-group">
                    <label for="newKpi">请输入要修改的成绩</label>
                    <input type="number"  class="form-control input-sm" id="newKpi"  name="newKpi">
                </div>
                <div class="col-sm-offset-4 col-sm-10" >
                    <button type="button" class="btn btn-default" id="submit1">修改</button>
                </div>
            </form>
        </div>
        <div class="col-md-5 col-md-offset-1" style="margin-top: 20px">
            ...
            <br>
            <div class="">
                <%--<label for="selectByName" class="col-sm-2 control-label">学号:--%>
                <div class="col-sm-10 form-group" style="margin-top: 20px">
                    <input type="text" class="form-control col-sm-10 input-sm" id="selectByName"  placeholder="请输入学号">
                </div>
                <br>
                <div class="col-sm-offset-2 col-sm-10" >
                    <button  class="btn btn-default " id="selectOne">查询</button>
                </div>
                    <table class="table table-hover" dispaly="none" style="table-layout: fixed;word-break: break-all;display: table;word-wrap: break-word" id="table_group" ></table>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $("#submit1").click(function () {
        $.ajax({
            url:"/changeOneHistoryKpi",
            data:{sId:$("#userId").val(),kpiNumber:$("#kpiNumber").val(),newKpi:$("#newKpi").val()},
    ...
    $("#table_group").bootstrapTable({
        ajax:function(request){                    //使用ajax请求
            $.ajax({
                type:"GET",
                url:'/selectOneHistoryKpi',
                contentType:'application/json;charset=utf-8',
                dataType:'json',
                data:{sId:$("#selectByName").val()},

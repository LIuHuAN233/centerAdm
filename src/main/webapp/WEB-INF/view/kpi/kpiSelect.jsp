...
<div class="down-main">
    ...
    <div class="row">
        ...
        <div class="col-md-5 col-md-offset-2" style="margin-top: 15px;">
            <h1 style="margin-left: 21px;">绩效综合查询</h1>

            <form class="form-horizontal" method="post" id="loginForm">
                <div class="form-group" style="margin-top: 20px;margin-left: 20px">
                    <label for="sId" class=" control-label">用户名：</label>
                    <div class="">
                        <input  name="username" id="sId"  placeholder="请输入用户名" autocomplete="off" class="form-control "
                        style="width: 200px;"
                        >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-left: 20px">
                    <label for="updateTime" class=" control-label">评审时间：</label>
                    <div class="">
                        <input type="date" name="updateTime" id="updateTime"  placeholder="请输入评审时间" autocomplete="off" class="form-control"
                        style="width: 200px;">
                    </div>
                </div>
                <br><br>
                <select  class="select" id="select1" style="margin-left: 20px;width: 150px;">
                ...
                <br>
                <br>
                <button type="button" id="selectByD"  class="btn " style="margin-left: 21px;">
                    查询
                </button>
                <br>
                <%--<button type="button" id="checkData" class="btn">
                    确认本次数据
                </button>--%>
            </form>
                ...
                <div class="panel-body" style="width: 100%;">
                    <table id="table-javascript"
                        ...
                        <th style="text-align: center; vertical-align: middle;"><div
                                class="th-inner ">用户名</div></th>
                        <th style="text-align: center; vertical-align: middle;"><div
                                class="th-inner ">姓名</div></th>
                        <th style="text-align: center; vertical-align: middle;"><div
                                class="th-inner ">成绩</div></th>
                        <th style="text-align: center; vertical-align: middle;"><div
                                class="th-inner ">评审时间</div></th>
                        <th style="text-align: center; vertical-align: middle;"><div
                                class="th-inner ">考评月次</div></th>
                        </thead>
...
<script type="text/javascript">
    ...
    $("#table_group").bootstrapTable({
        ajax:function(request){                    //使用ajax请求
            $.ajax({
                method:"post",
                url:'/selectKpiInformation',
                contentType:'application/x-www-form-urlencoded;charset=utf-8',
                dataType:'json',
                data:{sId:$("#sId").val(),updateTime:$("#updateTime").val(),kGroupName:($("#select1 option:selected").text())=="选择分组"?"":$("#select1 option:selected").text()},
                success:function (res) {
                    if (res=="111"){
                        request.success({
                            row:res,
        ...
        columns: [
            ...
            /*{
                ...
                valign:"middle",
                formatter:function (value,row,index) {
                   if (row.user.uStatus==0){
                       return "";
                   }else {
                       return  row.user.uStatus;
                   }
                }
    ...
    $(function(){
        ...
        $.ajax({
            ...
            success:function (result) {
                ...
                $("#select1").append($("<option value=\"0\">选择分组</option>"));
                $.each(assess,function (index,item) {
                    i++;
                    var test= $("#select1").append($("<option value=\"" + i+ "\">" + item.kGroupName+ "</option>"));
                })
            }
        });
        /*换肤*/

        ...
        $.ajax({
            ...
            success:function (result) {
                ...
                for (var i =0;i<result1.pmRateList.length;i++){
                    rateId++;
                    if (userName11==result1.pmRateList[i].ruId){
                        $("#projectRates1").append('<div class="col-sm-12" id = "rateBody'+rateId+'">\n' +
                            ...
                            '                </div>\n' +
                            '</br><a class="btn btn-link" href="/gotoChangeRate/'+result1.id+'/'+result1.pmRateList[i].rId+'">修改</a>\n'+
                            '        <a class="btn btn-link" href="/gotoDeleteOneRate/'+result1.id+'/'+result1.pmRateList[i].rId+'">删除</a>'+

    ...
    $(function(){
        ...
        $.ajax({
            ...
            success:function (result) {
                ...
                var rateList = result1.pmRateList;
                for (var i=0;i<rateList.length;i++){
                    if ("${rateId}"==rateList[i].rId+""){
                        projectId = rateList[i].rId;
                        $("#taskName").val(rateList[i].rName);
                        $("#myCode").val(rateList[i].rRate);
                        if (rateList[i].rFileName!="") {
                            var filenames = (rateList[i].rFileName).split(",");
                            var filePaths = (rateList[i].rFilePath).split(",");

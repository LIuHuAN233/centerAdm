        ...
        <div class="col-md-4 col-md-offset-2" style="margin-top: 20px">
            <form >
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="userId" name="sId">
                </div>

                <div class="form-group">
                    <label for="score">请输入修改的打分范围</label>
                    <input type="number" class="form-control" id="score" name="score">
                </div>
                <div class="form-group">
                    <label for="newLevel">请输入要修改的权限</label>
                    <input type="number" class="form-control" id="newLevel"  name="newLevel">
                </div>
                <div class="form-group">
                    <label for="newPassword">请输入要修改密码</label>
                    <input type="number" class="form-control" id="newPassword"  name="newPassword">
                </div>
...
<script type="text/javascript">
    ...
    $("#submit1").click(function () {
        $.ajax({
            url:"/changeOneUserInformation",
            data:{sId:$("#userId").val(),newScore:$("#score").val(),newLevel:$("#newLevel").val(),newPassword:$("#newPassword").val()},

        ...
        <div class="col-md-4 col-md-offset-2" style="margin-top: 20px">
            <form >
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="oldPassword"  name="oldPassword" placeHoder="密码长度6-16位"><span style="color: red;visibility:hidden" id="ops" >密码长度6-16位!</span>
                </div>
                <div class="form-group">
                    <label for="password">密码</label>
                    <input type="password" class="form-control" id="password"  name="password" placeHoder="密码长度6-16位"><span style="color: red;visibility:hidden" id="ps" >密码长度6-16位!</span>
                </div>
                <div class="form-group">
                    <label for="checkPassword">确认密码</label>
                    <input type="password" class="form-control" id="checkPassword"  name="checkPassword"><span style="color: red;visibility:hidden" id="cps" >两次密码输入不相同!</span>
                </div>
                <div class="col-sm-offset-4 col-sm-10" >
                    <button type="button" class="btn btn-default" id="submit1">提交</button>
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $("#password").blur(function () {
        ...
        if (6>$("#password").val().length || $("#password").val().length >16){
    ...
    $("#checkPassword").blur(function () {
        ...
        if ($("#checkPassword").val()!=$("#password").val()){
            ...
            $("#cps").css("visibility","visible")

        }else {
            $("#cps").css("visibility","hidden");
        }
    });
    $("#submit1").click(function () {
        if ((6>$("#password").val().length || $("#password").val().length >16)||($("#checkPassword").val()!=$("#password").val())){
            alert("密码位数错误或两次输入不同");
        }else {
            $.ajax({
                url:"/updatePasswordNormal",
                method:"post",
                data:{sId:$("#userId").val(),oldPassword:$("#oldPassword").val(),password:$("#password").val()},
                success:function (result) {
                    if (result==1){
                        alert("修改成功");
                    }else if (result==3){

    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-2" style="margin-top: 20px">
            <form >
                ...
                <div class="form-group">
                    <label for="score">打分范围</label>
                    <input type="number" class="form-control" id="score"  name="score" value="20">
                </div>
                <div class="form-group">
                    <label for="level">权限等级</label>
...
<script type="text/javascript">
    ...
    $("#submit1").click(function () {
        if ((6>$("#password").val().length || $("#password").val().length >16)||($("#checkPassword").val()!=$("#password").val())){
            ...
            $.ajax({
                url:"/addNewUserInformation",
                method:"post",
                data:{sId:$("#userId").val(),realName:$("#realName").val(),password:$("#password").val(),score:$("#score").val(),level:$("#level").val()},

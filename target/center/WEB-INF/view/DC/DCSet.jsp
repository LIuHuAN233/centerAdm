...
<div class="down-main row">
    <div class="left-main left-full">
        ...
        <div class="subNavBox">
            ...
            <div class="sBox">
                <div class="subNav sublist-up"><span class="title-icon glyphicon glyphicon-chevron-up"></span><span class="sublist-title">数据标注</span>
                </div>
                <ul class="navContent" style="display:none">
                    <li>
                        <div class="showtitle" style="width:100px;"><img src="/img/leftimg.png" />任务设置</div>
                        <a  href="/DCSet"><span class="sublist-icon glyphicon glyphicon-list-alt"></span><span class="sub-title">任务设置</span></a>
                    </li>
    ...
    <div class="row">
        <div class="header-nav" >
            <ul class="header-nav-list clearfix">
                <li class="nav-one"><a href="/pedestrianRecognition" class="nav-tit">任务设置</a> </li>
                <li class="nav-one"><a href="/" class="nav-tit">标注属性设置</a></li>

            </ul>
        </div>
        <div class="col-md-9 col-md-offset-2" id="content" style="margin-top: 50px;">

            <button class="btn btn-success" id="addNewWork" data-toggle="modal" data-target="#myModalAddWork">新建任务</button>
...
<!-- 添加的模态对话框 -->
<div id="myModalAddWork" class="modal fade"  role="dialog"   aria-hidden=true data-backdrop="static">
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                <h4 class="modal-title">
                    ...
                    <span id="lblAddTitle" style="font-weight:bold">新任务</span>
                </h4>
            </div>

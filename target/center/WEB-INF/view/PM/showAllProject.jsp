            ...
            if (row.pStatus==0){
                if (row.pFatherName==""){
                    return [
                        ...
                        '</a>&emsp;',
                        '<a class="edit ml10" style="color:black;" href="javascript:void(0)" title="修改">',
                        '<span class="glyphicon glyphicon-edit" style="color:#2aabd2"></span>',
                        '</a>&emsp;',
                        '<a class="addC ml10" style="color:black;" href="javascript:void(0)" title="添加子项目">',
                        '<span class="glyphicon glyphicon-plus" style="color: #398439"></span>',
                        '</a>&emsp;',
                        '<a class="remove ml10" style="color:black;" href="javascript:void(0)" title="删除">',
                        '<i class="glyphicon glyphicon-remove" style="color: #ac2925"></i>',
                        '</a>',

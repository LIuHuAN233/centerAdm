            ...
            <div class="sBox">
                ...
                <ul class="navContent" style="display:none">
                    <li>
                        ...
                        <a href="/browseBlog"><span class="sublist-icon glyphicon glyphicon-list-alt"></span><span class="sub-title">浏览文档</span></a> </li>
                    <li>
                        <div class="showtitle" style="width:100px;"><img src="/img/leftimg.png" />上传文档</div>
                        <a href="/addNewBlog"><span class="sublist-icon glyphicon glyphicon-envelope"></span><span class="sub-title">上传文档</span></a> </li>
                    <li>
                        <div class="showtitle" style="width:100px;"><img src="/img/leftimg.png" />我的文档</div>
                        <a href="/kpiSelect"><span class="sublist-icon glyphicon glyphicon-bullhorn"></span><span class="sub-title">我的文档</span></a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-8">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="w55 pull-left"><a>OIM*****************************</a></div>
                        <div class="w20 pull-left text-center">2019年09月27日</div>
                    </div>
